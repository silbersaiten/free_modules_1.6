...
class Easymarketing extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('easymarketing – Smart advertising on Google Shopping');
        $this->description = $this->l('easymarketing automatizes your advertising campaigns on Google and lowers your customers acquisition cost by 38%');
